(function(global) {
  ...
  Mapsheet.Providers.Google.prototype = {
      ...
      setMarkerIcon: function(marker) {
        ...
        var pinImage = new google.maps.MarkerImage(
          "http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=|" + pinColor, new google.maps.Size(21,
            34), new google.maps.Point(0, 0), new google.maps.Point(10, 34));
        var pinShadow = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_shadow", new google
          .maps.Size(40, 37), new google.maps.Point(0, 0), new google.maps.Point(12, 35));
  ...
  Mapsheet.Providers.MapQuest.prototype = {
      initialize: function(element) {
        if (typeof(this.map) === 'undefined') {
          this.map = new MQA.TileMap(merge_options({
            elt: element
          }, this.mapOptions));
        }
      },
  ...
  Mapsheet.Providers.MapBox.prototype = {
      ...
      drawMarker: function(point) {
        var marker = L.marker(point.coords()).bindPopup(point.content())
        if (typeof(point.get('icon url')) !== 'undefined' && point.get('icon url') !== '') {
          var options = merge_options(point.markerOptions, {
            iconUrl: point.get('icon url')
          });
  ...
  Mapsheet.Providers.Leaflet = function(options) {
    this.map = options.map;
    var attribution =
      'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, tiles &copy; <a href="http://www.mapquest.com/" target="_blank">MapQuest</a> <img src="http://developer.mapquest.com/content/osm/mq_logo.png" />';
    var layerDefaults = {
      styleId: 998,
